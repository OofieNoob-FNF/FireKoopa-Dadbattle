...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, 75, FlxG.width - 800, "BOTPLAY", 32);
	...
	override public function update(elapsed:Float)
	{
		...
		//displayHealth = FlxMath.lerp(displayHealth, health, CoolUtil.boundTo(elapsed * 20, 0, 1));
		
        displayHealth = FlxMath.lerp(displayHealth, health, CoolUtil.boundTo(0.2 * 60 * elapsed, 0, 1));
		...
		var percent:Float = 1 - (displayHealth / 2);
		iconP1.x = healthBar.x + (healthBar.width * percent) + (150 * iconP1.scale.x - 150) / 2 - iconOffset * 1.5;
		iconP2.x = healthBar.x + (healthBar.width * percent) - (150 * iconP2.scale.x) / 2 - iconOffset * 2.5;
